...
| section 8 listed intersections and `extends` as never read | it names what is followed in the file, and leaves only imported, generic and DOM parts out |
